...
public class CardStack extends RelativeLayout {
    ...
    private void setupAnimation(){
        ...
        mCardAnimator = new CardAnimator(viewCollection, mColor, CardStack.this.getContext());
        mCardAnimator.initLayout();
        ...
        final DragGestureDetector dd = new DragGestureDetector(CardStack.this.getContext(),new DragGestureDetector.DragListener(){
            ...
            public  boolean onDragEnd(MotionEvent e1, MotionEvent e2) {
                ...
                int temp = CardUtils.direction(x1,y1,x2,y2); // modified by dnbb - LJY
                final int direction = (temp == 1 || temp == 3) ? 3 : 2;// modified by dnbb - LJY
            ...
            public boolean onTapUp() {
                mEventListener.topCardTapped(mIndex);
                return true;
            }
        }
        );
